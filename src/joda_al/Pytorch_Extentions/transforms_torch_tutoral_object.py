#Source: https://github.com/pytorch/vision/blob/1d0786b0a35661408388ed4268e382f56bcde627/references/detection/transforms.py
...
__all__ = [
    "BoxRandomHorizontalFlip",
    "CombinedPILToTensor",
    "CombinedConvertImageDtype",
    "RandomIoUCrop",
    "RandomZoomOut",
...
class BoxRandomHorizontalFlip(RandomHorizontalFlip):
    def forward(
...
class CombinedPILToTensor(nn.Module):
    def forward(
        self, image: Tensor, target: Optional[Dict[str, Tensor]] = None
    ) -> Tuple[Tensor, Optional[Dict[str, Tensor]]]:
...
class CombinedConvertImageDtype(nn.Module):
...
class BoxFixedSizeCrop(nn.Module):

...
def datasetFactory(preprocessing, in_memory, data_subpath, label_subpath, files_extractor, timestamp_extractor, label_converter):
    if in_memory:
        func=lambda path: ProcessedSegmentationDatasetMem(path,data_subpath, label_subpath,
                                                         files_extractor, timestamp_extractor, label_converter,preprocessing)
    else:
        func=lambda path: ProcessedSegmentationDataset(path,data_subpath, label_subpath,
                                                         files_extractor, timestamp_extractor, label_converter,preprocessing)
    return func
...
class SegmentationDatasetMem(SegmentationDataset):
...
class ProcessedSegmentationDatasetMem(SegmentationDatasetMem, DatasetPreprocessing):
    def __init__(self, path: Union[List[str], str], input_subpath: str, label_subpath: str, files_extractor: Callable,
                 ...
                 *args, **kwargs):
        super(ProcessedSegmentationDatasetMem, self).__init__(path, input_subpath, label_subpath, files_extractor, time_stamp_extractor,
                         label_to_categorical, *args, **kwargs,preprocessing=preprocessing)


class ProcessedSegmentationDataset(SegmentationDataset, DatasetPreprocessing):
    def __init__(self, path: Union[List[str], str], input_subpath: str, label_subpath: str, files_extractor: Callable,
                 time_stamp_extractor: Optional[Callable], label_to_categorical: Callable, preprocessing: PreProcessingDef,
                 *args, **kwargs):
        super(ProcessedSegmentationDataset, self).__init__(path, input_subpath, label_subpath, files_extractor, time_stamp_extractor,
                         label_to_categorical, *args, **kwargs,preprocessing=preprocessing)
